...
namespace Alien_Attack
{
    internal class Database
    {
        ...
        public Database(Leaderboard leaderboard) {
            connectionString = "Host=192.168.1.163;Username=Admin;Password=Tru3N4s7;Database=AlienAttack";        //Local
            //connectionString = "Host=145.40.145.246:5432;Username=Admin;Password=Tru3N4s7;Database=AlienAttack";    //Global
