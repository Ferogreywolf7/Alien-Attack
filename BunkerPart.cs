...
namespace Alien_Attack
{
    internal class BunkerPart
    {
        ...
        private const int partWidth = 10;
        private const int partHeight = 10;
        ...
        public void updateBunkerPart() {
            ...
            sourceRectangle = new Rectangle(10 * destructionCount, 10 * destructionCount, partWidth, partHeight);
        }
